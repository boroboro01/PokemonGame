...
public class Ivysaur extends Pokemon{
	private static final int pokeID = 2;

	public Ivysaur(String pokeName, String pokeType, int pokeLevel, int pokeTotalHP, int pokeHP, int pokePhysicDamage, int pokePhysicDefense,
